...
class Source2Info:
    def __init__(
        ...
        self.appearance_extractor = AppearanceExtractor(**appearance_extractor_cfg)  # Как раз Appearance Extractor <F>
        self.motion_extractor = MotionExtractor(**motion_extractor_cfg)  # Motion Extractor <M>
    ...
    def __call__(self, img, last_lmk=None, **kwargs):
        ...
        fs = self._get_f3d(rgb_256_bchw)  # <F> - appearance extractor
